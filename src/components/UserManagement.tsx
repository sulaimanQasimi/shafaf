                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-gray-600 dark:text-gray-400 mt-1">مدیریت کاربران سیستم</p>
                            </div>
                        </div>
                        <motion.button
                            ...
                            className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200"
                        >
                    ...
                    >
                        <div className="flex flex-col items-center gap-4">
                            ...
                            <p className="text-gray-600 dark:text-gray-400 text-xl font-semibold">
                                {searchQuery ? "نتیجه‌ای یافت نشد" : translations.noUsers}
                            </p>
                            <p className="text-gray-500 dark:text-gray-500 text-sm">
                                {searchQuery ? "جستجوی دیگری امتحان کنید" : "برای شروع، یک کاربر جدید اضافه کنید"}
                            </p>
                        </div>
                    </motion.div>
                ) : (
                                ...
                                >
                                    <div className="flex flex-col md:flex-row justify-between items-start gap-6">
                                        <div className="flex-1 space-y-4">
                                            {/* Header */}
                                            <div className="flex items-center gap-4">
                                                <div className={`w-16 h-16 bg-gradient-to-br ${user.is_active ? 'from-purple-500 to-blue-500' : 'from-gray-400 to-gray-500'} rounded-2xl flex items-center justify-center shadow-lg`}>
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <span className={`px-3 py-1 text-xs font-bold text-white rounded-full bg-gradient-to-r ${getRoleBadgeColor(user.role)}`}>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                                <motion.div
                                                    ...
                                                    className="flex items-center gap-3 p-3 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl border border-blue-200/50 dark:border-blue-700/30"
                                                >
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="font-bold text-gray-900 dark:text-white text-sm" dir="ltr">{user.email}</div>
                                                    </div>
                                                </motion.div>
                                                ...
                                                {user.phone && (
                                                    ...
                                                    >
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="font-bold text-gray-900 dark:text-white" dir="ltr">{user.phone}</div>
                                                        </div>
                                                    </motion.div>
                                                )}
                                                ...
                                                <motion.div
                                                    whileHover={{ scale: 1.02 }}
                                                    className={`flex items-center gap-3 p-3 rounded-xl border ${user.is_active
                                                            ? "bg-gradient-to-r from-emerald-50 to-green-50 dark:from-emerald-900/20 dark:to-green-900/20 border-emerald-200/50 dark:border-emerald-700/30"
                                                            : "bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-900/20 dark:to-pink-900/20 border-red-200/50 dark:border-red-700/30"
                                                        }`}
                                                >
                                                    <svg className={`w-5 h-5 ${user.is_active ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-600 dark:text-red-400'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        {user.is_active ? (
                                                    ...
                                                    <div>
                                                        <div className="text-xs text-gray-600 dark:text-gray-400">{translations.status}</div>
                                                        <div className={`font-bold ${user.is_active ? 'text-emerald-700 dark:text-emerald-400' : 'text-red-700 dark:text-red-400'}`}>
                                            ...
                                            <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-500 pt-2 border-t border-gray-200 dark:border-gray-700">
                                                <div className="flex items-center gap-1">
                                                    ...
                                                    <span>ایجاد: {new Date(user.created_at).toLocaleDateString('fa-IR')}</span>
                                                </div>
                                                {user.updated_at && (
                                                    <div className="flex items-center gap-1">
                                                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                        ...
                                                        <span>بروزرسانی: {new Date(user.updated_at).toLocaleDateString('fa-IR')}</span>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-row md:flex-col gap-2 w-full md:w-auto">
                                            ...
                                            <motion.button
                                                ...
                                                className={`flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl shadow-md hover:shadow-lg transition-all duration-200 font-semibold flex-1 md:flex-initial disabled:opacity-50 disabled:cursor-not-allowed ${user.is_active
                                            ...
                                            >
                                                ...
                                                <span className="hidden md:inline">{user.is_active ? 'غیرفعال' : 'فعال'}</span>
                                            </motion.button>
                                            ...
                                            <motion.button
                                                ...
                                                className="flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white rounded-xl shadow-md hover:shadow-lg transition-all duration-200 font-semibold flex-1 md:flex-initial"
                                            >
                                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                                </svg>
                                                <span className="hidden md:inline">{translations.edit}</span>
                                            </motion.button>
                                            ...
                                            <motion.button
                                                ...
                                                disabled={currentUser?.id === user.id}
                                                className="flex items-center justify-center gap-2 px-4 py-2.5 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white rounded-xl shadow-md hover:shadow-lg transition-all duration-200 font-semibold flex-1 md:flex-initial disabled:opacity-50 disabled:cursor-not-allowed"
                                            >
                                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                                </svg>
                                                <span className="hidden md:inline">{translations.delete}</span>
                                            </motion.button>
                                        </div>
                                    </div>
                                </motion.div>
